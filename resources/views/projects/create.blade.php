<x-app-layout>
    <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data"
        class="mt-4 max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg">
        @csrf
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-2xl font-semibold text-gray-900">Create Project</h2>
                <p class="mt-1 text-sm text-gray-600">Fill out the details of your new project.</p>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <input type="text" name="title" id="title" required
                                class="bg-gray-200 px-2 h-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>

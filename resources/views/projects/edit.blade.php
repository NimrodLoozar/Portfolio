        ...
        <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description"
                    class="mt-1 px-4 pt-4 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description', $project->description) }}</textarea>
            </div>

            <div class="mb-4">
                <label for="heading1" class="block text-sm font-medium text-gray-700">Heading 1</label>
                <textarea name="heading1" id="heading1"
                    class="mt-1 px-4 pt-4 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('heading1', $project->heading1) }}</textarea>
            </div>

            <div class="mb-4">
                <label for="heading2" class="block text-sm font-medium text-gray-700">Heading 2</label>
                <textarea name="heading2" id="heading2"
                    class="mt-1 px-4 pt-4 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('heading2', $project->heading2) }}</textarea>
            </div>

<div id="contact" class="py-24 sm:py-32">
    <div id="fade-animationLeft" class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            ...
            <p class="mt-2 text-lg text-gray-600 dark:text-gray-300">Feel free to reach out to me through the following
                methods:</p>
        </div>
        <div class="mt-10">

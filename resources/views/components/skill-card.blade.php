<div
    class="flex flex-col items-center justify-between bg-gradient-to-br {{ $bg }} p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 {{ $border }} skill-card group hover:scale-105 {{ $showChart ? 'min-h-[240px]' : 'min-h-[160px]' }}">
